var serverFile='http://192.168.1.123/Web/fnc/ajaxfnc2.php';
$(function(){
    ...
    $.ajax({
        ...
        for(i=0;i<tlay.length;i++){
            ...
            if(!exists){
                ...
                $('#home ul').append('<li tlayuda="'+tlay[i].tlaId+'"><table style="width=100%;"><tr><td rowspan="2"><button class="preparada">Listo</button></td><td>'+tlay[i].producto+'</td><td>'+mesa+'</td><td rowspan="2"><button class="lista">Listo</button></td> </tr><tr><td colspan="2" class="comments"></td></tr></table></li>');
			}
        }
    });
}
